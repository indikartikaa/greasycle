...
<head>
    ...
    <title>Profil - Zahlul Noer Laily</title>
...
<body class="bg-[#f7faf9] text-gray-800 leading-relaxed font-sans">
            ...
            <div class="flex flex-col md:flex-row items-center gap-12">
                <div class="relative group">
                    <div class="w-64 h-64 rounded-[2rem] overflow-hidden custom-profile-shadow transition-transform duration-500 group-hover:scale-[1.02]">
                        <img src="assets/images/foto-zahlul.jpeg" alt="Zahlul Noer Laily" class="w-full h-full object-cover">
                    </div>
                </div>
                ...
                <div class="flex-1 text-center md:text-left">
                    ...
                    <p class="text-lg text-gray-600 leading-relaxed max-w-2xl italic">
                        Saya merupakan Lead Developer pada proyek Greasycle yang bertanggung jawab dalam pengembangan sistem, pengelolaan struktur kode, serta implementasi teknologi website. Saya memastikan setiap fitur berjalan dengan optimal, aman, dan memiliki performa yang baik.
                    </p>
                </div>
            </div>
        </section>
        ...
        <section class="grid lg:grid-cols-3 gap-8 mb-20">
            ...
            <div class="space-y-6">
                <div class="bg-white p-6 rounded-3xl shadow-sm border border-gray-100 flex items-start gap-4">
                    <div class="p-3 bg-lightGreen rounded-2xl text-secondary"><i class="fas fa-code text-xl"></i></div>
                    <div>
                ...
                <div class="bg-white p-6 rounded-3xl shadow-sm border border-gray-100 flex items-start gap-4">
                    <div class="p-3 bg-lightGreen rounded-2xl text-secondary"><i class="fas fa-layer-group text-xl"></i></div>
                    <div>
                ...
                <div class="bg-white p-6 rounded-3xl shadow-sm border border-gray-100 flex items-start gap-4">
                    <div class="p-3 bg-lightGreen rounded-2xl text-secondary"><i class="fas fa-users-cog text-xl"></i></div>
                    <div>
        ...
        <section class="grid md:grid-cols-2 gap-8 items-stretch mb-12">
            <div class="bg-primary text-white p-8 rounded-[2.5rem] shadow-xl">
                <h3 class="text-xl font-bold mb-6 flex items-center gap-2">
                    <i class="fas fa-laptop-code text-accent"></i> Core Skills
                </h3>
                <div class="flex flex-wrap gap-3">
                    <div class="flex items-center gap-2 bg-white/10 px-4 py-2 rounded-xl border border-white/10 hover:bg-white/20 transition cursor-default">
                        <i class="devicon-html5-plain colored"></i> <span class="text-sm font-semibold">HTML5</span>
                    </div>
                    <div class="flex items-center gap-2 bg-white/10 px-4 py-2 rounded-xl border border-white/10 hover:bg-white/20 transition cursor-default">
                        <i class="devicon-css3-plain colored"></i> <span class="text-sm font-semibold">CSS3</span>
                    </div>
                    <div class="flex items-center gap-2 bg-white/10 px-4 py-2 rounded-xl border border-white/10 hover:bg-white/20 transition cursor-default">
                        <i class="devicon-javascript-plain colored"></i> <span class="text-sm font-semibold">JavaScript</span>
                    </div>
                    <div class="flex items-center gap-2 bg-white/10 px-4 py-2 rounded-xl border border-white/10 hover:bg-white/20 transition cursor-default">
                        <i class="devicon-github-original"></i> <span class="text-sm font-semibold">GitHub</span>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white p-8 rounded-[2.5rem] shadow-sm border border-gray-100 flex flex-col justify-center items-center text-center">
                ...
                <div class="flex gap-6">
                    <a href="https://linkedin.com/" target="_blank" 
                       class="w-14 h-14 bg-lightGreen rounded-2xl flex items-center justify-center text-[#0077b5] text-2xl hover:bg-primary hover:text-white transition-all duration-300 shadow-sm">
                        <i class="fab fa-linkedin"></i>
                    </a>
                    <a href="https://github.com/" target="_blank" 
                       class="w-14 h-14 bg-lightGreen rounded-2xl flex items-center justify-center text-gray-900 text-2xl hover:bg-primary hover:text-white transition-all duration-300 shadow-sm">
    ...
    <footer class="bg-white border-t border-gray-100 py-8 text-center mt-20">
        <p class="text-[10px] text-gray-400 uppercase tracking-widest">
            &copy; <?= date('Y'); ?> Greasycle. Profile page by <span class="font-bold text-primary italic">Zahlul Noer Laily</span>.
        </p>
    </footer>
