    ...
    <div class="container mx-auto px-[8%] grid grid-cols-1 md:grid-cols-3 gap-12">
        ...
        <div>
            ...
            <ul class="text-accent opacity-80 space-y-4 text-sm">
                ...
                <li><a href="contact.php" class="hover:text-white transition underline">Kontak</a></li>
                <li><a href="portofolio.php" class="hover:text-white transition">Portofolio</a></li>
            </ul>
        </div>
    </div>
